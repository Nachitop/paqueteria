...
export class InformacionenvioComponent implements OnInit {
  ...
  iniciarForm(){
    this.formInformacionEnvio=this.fb.group({
      ...
      email_r:['',[Validators.email]],
      telefono_r:['',[Validators.required,Validators.pattern("[0-9]{10}")]],
      ...
      email_d:['',[Validators.pattern("")]],
      telefono_d:['',[Validators.required,Validators.pattern("[0-9]{10}")]],
